...
class mainGUI(object):
    ...
    def interface(self):
        ...
        self.Button_chooseDir = Button(self.win, text='指定目录', command=self.chooseDir)
        ...
        self.Button_xml2Cpal  .place(x=330, y=720)
    ...
    def xml2cpal_start(self):
        self.T8 = threading.Thread(target=Xml2Cpal.Xml2cpal(xml_path,self.msg_queue))
